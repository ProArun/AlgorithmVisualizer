...
import com.arun.algovisualizer.presentation.InsertionSortViewModel
...
@Composable
fun InsertionSort(modifier: Modifier = Modifier, onMenuClicked: (option: Option) -> Unit) {
    val insertionSortViewModel = InsertionSortViewModel()
    var colorList =
        remember {
    ...
    Column(
        ...
        LazyColumn(
            ...
            items(
                insertionSortViewModel.listToSort,
                key = {
                    it.id
                }
            ) {
