...
import com.arun.algovisualizer.presentation.ReverseViewModel
...
@Composable
fun Reverse(modifier: Modifier = Modifier, onMenuClicked: (option: Option) -> Unit) {
    val reverseViewModel = ReverseViewModel()
