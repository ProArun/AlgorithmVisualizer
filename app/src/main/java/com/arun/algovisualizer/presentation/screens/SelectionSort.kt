...
import com.arun.algovisualizer.presentation.SelectionSortViewModel
...
@Composable
fun SelectionSort(modifier: Modifier = Modifier, onMenuClicked: (option: Option) -> Unit) {
    val selectionSortViewModel = SelectionSortViewModel()
    ...
    Column(
        ...
        LazyColumn(
            ...
            items(
                selectionSortViewModel.listToSort,
                key = {
                    it.id
                }
            ) {
